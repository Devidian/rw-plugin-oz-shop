...
public class Shop extends Plugin implements Listener, FileChangeListener {
    ...
    public void onEnable() {
        ...
        zoneService = new ShopZoneService(this, sqliteCon, s.shopZonesFile);
    ...
    public List<ShopOffer> listSystemOffers(Player player) {
        ...
        return SystemOfferFile.load(this, offerFile, s.generateDefinitionExports, s.systemShopCurrency);
    }
    ...
    private Optional<ShopOffer> findSystemOfferFor(Player player, String offerId) {
        ...
        return SystemOfferFile.load(this, offerFile, s.generateDefinitionExports, s.systemShopCurrency).stream()
